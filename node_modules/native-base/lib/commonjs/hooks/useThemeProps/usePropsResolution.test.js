...
describe('props resolution', () => {
  ...
  it('Input: Basic check', () => {
    ...
    expect(inputElement.props.style[0].marginLeft).toBe(_theme.theme.space['3']);
    expect(inputElement.props.style[0].marginRight).toBe(_theme.theme.space['3']);
  });
  it('Input: color mode', () => {
    const newTheme = (0, _extendTheme.extendTheme)({
      config: {
  ...
  it('Input: size', () => {
    ...
    const inputElement = getByTestId('test');
    expect(inputElement.props.style[0].fontSize).toBe(_theme.theme.fontSizes.sm);
  });
  it('Input: variant', () => {
    const {
      getByTestId
  ...
  it('Input: style props test on ios with dark mode', () => {
    ...
    const inputElement = getByTestId('test');
    expect(inputElement.props.style[0].borderBottomWidth).toBe(1); // as input of 'sm' size is mapped to 'xs' fontsize

    expect(inputElement.props.style[0].fontSize).toBe(_theme.theme.fontSizes.xs);
